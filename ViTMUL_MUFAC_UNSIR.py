...
#     show_images(imgs[7:19], label_strs, nrow=6)
    ...
    for seed in args.seeds:
        ...
        # args.model_type
        print('-'*77)
        if args.training_type.lower() in ['unsir']:
        ...
        for epoch in range(2):
            ...
            for batch_idx, ((x_retain, y_retain), (x_forget, y_forget)) in enumerate(tqdm(zip(retain_dataloader_train, forget_dataloader_train))):
                ...
                outputs = model(noise_tensor.cuda())
